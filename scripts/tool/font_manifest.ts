...
export function createFontManifest(params: FontManifestParams): Manifest {
    return {
        ...
        url: `${github_url}${params.user_name}/${params.repository_name}/releases/download/v${params.version}/${params.file_name}`,
        hash: params.hash,
        checkver,
        autoupdate: {
            url: `${github_url}${params.user_name}/${params.repository_name}/releases/download/v$version/${params.autoupdate_file_name}`,
        },
        installer: {
